...
export default function FeatureDeepDive({ onOpenCheckout, price18m = 299 }: FeatureDeepDiveProps) {
  ...
  const tabs = [
    ...
    {
      id: "storage-cloud",
      title: "5 TB Google One Cloud",
      icon: <HardDrive className="w-4 h-4" />,
      tagline: "৫,০০০ জিবি গুগল ওয়ান ক্লাউড স্পেস ও ব্যাকআপ",
      headline: "স্মার্টফোন ও পিসির জন্য বিশাল ক্লাউড ব্যাকআপ",
      description:
        "আর কখনো 'Storage Full' মেসেজ আসবে না। ৫ টেরাবাইট হাই-স্পিড ক্লাউড স্টোরেজে আপনার সমস্ত ছবি, ভিডিও ও ফাইল অরিজিনাল কোয়ালিটিতে নিরাপদ ব্যাকআপ রাখুন এবং সর্বোচ্চ ৫ জন ফ্যামিলি মেম্বারের সাথে শেয়ার করুন।",
      perks: [
        "৫,০০০ GB (5 TB) গুগল ওয়ান হাই-স্পিড ক্লাউড স্টোরেজ",
        "Google Photos-এ আনলিমিটেড হাই-কোয়ালিটি ফটো ও 4K ব্যাকআপ",
        "এক সাবস্ক্রিপশনে পরিবারের সর্বোচ্চ ৫ জন সদস্যের সাথে শেয়ার",
        "Google Drive ও Gmail-এর সাথে সম্পূর্ণ অটোমেটিক সিঙ্ক",
      ],
