  ...
  const reviews = [
    {
      ...
      content:
        `Gemini 3.1 Pro কোডিং এবং বড় আর্কিটেকচার পর্যালোচনায় অসাধারণ কাজ করে। সাথে ৫ টেরাবাইট ড্রাইভ স্টোরেজ পাওয়ার পর আমার সমস্ত প্রোজেক্ট ফাইল ব্যাকআপ নিরাপদ হয়েছে। মাত্র ৳${price18m}-এ এত সুবিধা অবিশ্বাস্য!`,
      rating: 5,
    },
    {
      name: "নুসরাত জাহান",
